...
- Portable HTTPS trust for update checks across Ubuntu-built packages and Fedora/Bazzite hosts by embedding a pinned Mozilla CA bundle while retaining host trust.
